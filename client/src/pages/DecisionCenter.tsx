    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      {loading ? (
        ...
        <div className="fintech-card p-12 text-center space-y-4">
          ...
          <h3 className="text-base font-bold text-slate-900">No Decisions Recorded for this Intent</h3>
          <p className="text-xs text-slate-600 max-w-sm mx-auto">
            Evaluate a candidate proposal in Commerce Simulator to view real-time governance analysis.
          </p>
          <Link
            to="/simulation"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold shadow-sm"
          >
        ...
        <div className="space-y-6">
          ...
          <div className="fintech-card p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs text-slate-600 font-mono font-semibold">
                    Decision ID: <span className="text-blue-600">{latestDecision.id}</span>
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
              <div className="p-3.5 rounded-lg bg-slate-50 border border-slate-200">
                ...
                <span className="font-bold text-slate-900 line-clamp-1 mt-0.5 text-sm">
              ...
              <div className="p-3.5 rounded-lg bg-slate-50 border border-slate-200">
                ...
                <span className="font-extrabold text-slate-900 tabular-nums mt-0.5 block text-base">
                  ₹{latestDecision.proposal?.amount?.toLocaleString()} <span className="text-xs text-slate-500 font-mono font-normal">INR</span>
                </span>
              </div>
              ...
              <div className="p-3.5 rounded-lg bg-slate-50 border border-slate-200">
                ...
                <span
                  className={`font-extrabold tabular-nums mt-0.5 block text-sm ${
          ...
          <div className="fintech-card p-6 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-200">
              ...
              <span className="text-[11px] font-mono text-slate-500 font-semibold">6-Stage Evaluation Sequence</span>
            </div>
          ...
          <div className="fintech-card p-6 space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-slate-200 text-slate-600 uppercase text-[10px] tracking-wider bg-slate-50 font-bold">
                  ...
                  {filteredChecks.map((chk) => (
                    <tr key={chk.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3 px-4">
                        ...
                        >
                          {chk.status === "PASS" && <CheckCircle2 className="w-3.5 h-3.5" />}
                          {chk.status === "WARN" && <AlertTriangle className="w-3.5 h-3.5" />}
                          {chk.status === "FAIL" && <ShieldAlert className="w-3.5 h-3.5" />}
